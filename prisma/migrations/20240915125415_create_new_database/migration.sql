/*
  ...
  - You are about to drop the `ProductsCart` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "ProductsCart" DROP CONSTRAINT "ProductsCart_cartId_fkey";

-- DropForeignKey
ALTER TABLE "ProductsCart" DROP CONSTRAINT "ProductsCart_productId_fkey";
